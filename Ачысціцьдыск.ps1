...
#GUI Variables
$FormTitleText = "Ачышчальнік дыска Джыма Тайлера (PowerShellEngineer.com)"
$SelectDiskLabelText = "Абярыце дыск:"
$FreeSpaceLabelText = "Вольнае месца (гігабайт): "
$TotalSpaceLabelText = "Агульная прастора (гігабайт): "
$JunkFoundLabelText = "знойдзена смецце (гігабайт):"
$CleanDiskBtnText = "Ачысціць дыск *Выдаліць файлы*"
$SpaceCleanedLabelText = "Ачышчаная прастора (гігабайты): "
$LogFileLabelText = "Знойдзены файл журнала: $abcdefg"
$CreditLabelText = "Сцэнар Джыма Тайлера - PowerShellEngineer.com"
$LogFileLocatedText = "Знойдзены файл журнала"
$AnalyzingDriveText = "Аналіз дыскаў..."
$BrowsersAreRunningText = "Браўзеры запушчаны... Апавясціць карыстальніка..."
$PleaseCloseBrowsersText = "Калі ласка, зачыніце ўсе вэб-браўзеры і паўтарыце спробу."
$CleaningDriveText = "Ачыстка дыска..."
